/**
 * ForgotPasswordPage - Página de recuperación de contraseña premium.
 * Diseño elegante con modo claro/oscuro consistente.
        ...
        <div className="p-8 sm:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className={`text-sm ${isLight ? 'text-charcoal-500' : 'text-charcoal-400'}`}>
              Le enviaremos instrucciones a su email
            </p>
          </div>
